import { ArgumentRangeError, OptionError } from "../errors/mod.ts";
    ...
    if (typeof first === "string") {
        switch (arguments.length) {
            case 2:
                Deno.test(
                    arguments[0],
                    arguments[1] as (t: Deno.TestContext) => void | Promise<void>,
                );
                return;
            ...
            case 3:
                Deno.test(
                    arguments[0],
                    arguments[1] as Omit<ITestDefinition, "name" | "fn">,
                    arguments[2],
                );
                return;
