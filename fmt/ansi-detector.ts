import { IS_DARWIN, IS_WINDOWS, OS_RELEASE_VERISON } from "../os/constants.ts";
import * as env from "../os/env.ts";
import { equalsIgnoreCase, startsWithIgnoreCase } from "../primitives/str.ts";
...
export function detectMode() {
    ...
    if (IS_WINDOWS) {
        ...
        const v = OS_RELEASE_VERISON.split(".");
